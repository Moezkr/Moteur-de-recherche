...
def run_evaluation(file_path):
    try:
        ...
        print(f"Erreur de lecture ou nettoyage des données Excel {e}")
        return pd.DataFrame() 
...
if __name__ == "__main__":
    ...
    try:
        ...
        if results_df.empty:
            ...
            print("\n" + "="*80)
            print("Résultats d'Évaluation : Comparaison Booléen vs Vectoriel")
            print("="*80 + "\n")
            ...
            print("\nRésultats sauvegardés dans evaluation_report.md")

    except FileNotFoundError:
        print(f"Fichier introuvable {xlsx_file} Vérifiez le chemin")
    except Exception as e:
